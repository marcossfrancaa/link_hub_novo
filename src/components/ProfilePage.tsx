...
export const ProfilePage: React.FC<ProfilePageProps> = ({ profile, onLinkClick }) => {
  ...
  return (
    <>
      <SEOHead 
        title={`@${profile.username} | Link Hub Creator`}
        description={profile.bio || 'Confira meus links importantes no Link Hub Creator'}
        type="profile"
      />
      <div className="min-h-screen w-full transition-colors duration-300" style={{ backgroundColor: profile.theme.backgroundColor, color: profile.theme.linkFontColor }}>
